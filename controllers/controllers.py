...
class SolanaController(http.Controller):
    @http.route('/shop/payment/solana/submit', type='json', auth='public', website=True)
    ...
    # @http.route('/shop/payment/solana/confirm', type='json', auth='none', methods=['POST'])
    # def confirm_solana_payment(self, **kwargs):
    # TODO implement support for webhook: https://docs.solana.com/apps/jsonrpc-api#subscription-websocket
    # dependency https://github.com/michaelhly/solana-py/issues/45
    #     pass
